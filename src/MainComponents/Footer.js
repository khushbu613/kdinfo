                  ...
                  <div className="row">
                     <div className="col-lg-3 col-md-6 col-sm-12">
                        <div className="footer-widget footer-4-col-1 mb-30">
                           ...
                           <div className="footer-widget-content">
                              <p className="footer-widget-text mb-20">Create captivating websites that elevate your brand. Our design and development expertise ensures a powerful online presence.
                                </p>
                              <div className="fooer-btn-4">
                                 <a className="blue-btn" href="contact-us.php">Contact Us</a>
                              </div>
                           </div>
                        </div>
                     </div>
                     <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="footer-widget  footer-4-col-2 pl-30 mb-40">
                           <h4 className="footer-widget-title mb-15">Useful Links</h4>
                           <div className="footer-widget-link">
                              <ul>
                                 <li><i className="fas fa-arrow-right"></i><a href="index.php">Home</a></li>
                                 <li><i className="fas fa-arrow-right"></i><a href="about-us.php">About Us</a></li>
                                 <li><i className="fas fa-arrow-right"></i><a href="#">Pricing</a></li>
                                 
                                 <li><i className="fas fa-arrow-right"></i><a href="#">Blogs</a></li>
                                 <li><i className="fas fa-arrow-right"></i><a href="contcat-us.php">Contact Us</a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
                     <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="footer-widget  footer-4-col-3 mb-40">
                           <h4 className="footer-widget-title mb-15">Services</h4>
                           <div className="footer-widget-link">
                              <ul>
                                 <li><i className="fas fa-arrow-right"></i><a href="landing-website.php">Landing Website</a></li>
                                 <li><i className="fas fa-arrow-right"></i><a href="static-website.php">Static Website</a></li>
                                 <li><i className="fas fa-arrow-right"></i><a href="wordpress-website.php">WordPress Website</a></li>
                                 <li><i className="fas fa-arrow-right"></i><a href="ecommerce.php">Ecommerce</a></li>
                                 <li><i className="fas fa-arrow-right"></i><a href="email-template-signature.php">Email Template/Signature</a></li>
                                 <li><i className="fas fa-arrow-right"></i><a href="api-integration.php">API Integration</a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
                     <div className="col-lg-3 col-md-6 col-sm-8">
                        <div className="footer-widget  footer-4-col-4 mb-40">
                           <h4 className="footer-widget-title mb-20"> Partner Programs
</h4>
                           <div className="footer-widget-link">
                            <ul>
                              <li><i className="fas fa-arrow-right"></i><a href="become-an-affiliate.php">Become An Affiliate</a></li>
                            </ul>
                              
                           </div>
                           <div className="footer-widget-social mt-20">
                           <h4 className="footer-widget-title mb-20"> Follow Us
</h4>
                  ...
                  <div className="row">
                     <div className="col-lg-12">
                        <div className="footer-widget-copyright footer-widget-copyright-4 text-center">
                           <div className="footer-copyright-ul">
                           <ul>
                              <li>© 2023<a target="_blank" href="index.php" className="copyright-name">KDInfoSystems</a> All Rights Reserved.</li>
